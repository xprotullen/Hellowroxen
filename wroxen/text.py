...
/id - ID प्राप्त करें
/set_skip - स्किप संदेश सेट करें। यानि उस मैसेज की आईडी जहां से फॉरवर्ड शुरू करना चाहते हैं।
/set_channel - लक्षित चैनल सेट करें।
/set_caption - फ़ाइल कैप्शन सेट करें।
